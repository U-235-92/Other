package com.other.network.udp.file.server;
...
private final static String SERVER_MSG_HEADER = "[Server message]: ";
	...
	public void receiveFile() throws FileNotFoundException, IOException {
		...
		try(FileOutputStream fos = new FileOutputStream(new File("src/com/other/network/udp/file/server/alaskaReceive.jpg"))) {
			while(true) {
